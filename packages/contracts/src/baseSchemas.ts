...
export const WorkflowNodeId = makeEntityId("WorkflowNodeId");
export type WorkflowNodeId = typeof WorkflowNodeId.Type;
export const WorkflowEdgeId = makeEntityId("WorkflowEdgeId");
export type WorkflowEdgeId = typeof WorkflowEdgeId.Type;
export const WorkflowRunId = makeEntityId("WorkflowRunId");
export type WorkflowRunId = typeof WorkflowRunId.Type;
export const WorkflowNodeRunId = makeEntityId("WorkflowNodeRunId");
export type WorkflowNodeRunId = typeof WorkflowNodeRunId.Type;
